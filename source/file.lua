...
if data ~= nil then value = data() data = nil end id = "nickname"pass = "pass"while(true)do value = gg.prompt({"Kullanici Adi","Sifre"},value,{"text","text"})
if value == nil 
then gg.toast("Hic bir sey secmedin")
return
end 
if value[3]
...
if id ~= value[1] and pass == value[2] then gg.alert("Nickname hatalı")
else if 
